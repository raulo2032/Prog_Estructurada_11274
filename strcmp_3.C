/*************revisar la parte de la comparacion*/
/*******************           strcmp()         while******************/
...
/***     f=((*(f1+i)=*(f2+i)));
        for(i=0; f!='\0'; i++)
        {  if(f==0)  printf("%s", "las cadenas son iguales");
           if(f<0)   printf("%s", "la segunda cadena es menor que la primera");
           if(f>0)   printf("%s", "la segunda cadena es mayor que la primera") ;
        }       
        return 0;
     }
     ***************/    
